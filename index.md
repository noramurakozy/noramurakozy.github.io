...
The website is a result of the analysis made from [this Python notebook](https://nbviewer.jupyter.org/github/christianpilgaard/notebook/blob/main/notebook.ipynb).
